...
| 目录 | 文件数 | 总行数 | 说明 |
|------|--------|--------|------|
| `src/components/` | 30 | 9552 | Vue UI 组件 |
| `src/composables/` | 24 | 3220 | 组合式函数（逻辑复用） |
| `src/views/` | 19 | 9504 | 页面（含 `settings/` 子目录 5 个 Tab 子组件） |
| `src/styles/` | 5 | 2847 | CSS 设计系统（含 Sharp Grid 全局深色配方） |
